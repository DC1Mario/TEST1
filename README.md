...
<style>
  ...
  header h1 { font-size: 1.8em; margin: 0.2em 0; }
  ...
  nav a { text-decoration: none; color: #0044cc; font-weight: bold; padding: 10px 15px; display: block; }
  ...
  nav ul ul li a { color: #000; padding: 10px; }
  nav ul ul li a:hover { background-color: #ddd; }
...
.page.active {
  ...
  h3 { color: #cc0000; }
  .contact h3 { color: #ffff00; background-color: #333; padding: 0.5em; }
...
<header>
   ...
   <main id="home_page" class="page active">
    ...
    <section>
      <h3>Links:</h3>
      <ul>
      <a href="https://web.archive.org/web/20171022231823if_/https://miiverse.nintendo.net/posts/AYQHAAABAACXVHho1Y0iOA">F1Ray's statement</a>
